...
public class RestTemplateResponseErrorHandler implements ResponseErrorHandler {
    ...
    public void handleError(ClientHttpResponse clientHttpResponse) throws IOException {
        ...
        CustomErrorMessage customErrorMessage = new ObjectMapper().readValue(clientHttpResponse.getBody(), CustomErrorMessage.class);

        throw new CustomException(customErrorMessage);
    }
